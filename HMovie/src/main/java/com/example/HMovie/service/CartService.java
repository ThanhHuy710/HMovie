...
public class CartService {
    ...
    @Cacheable(value = "CartRepository", key = "'allCarts'")
    ...
    @PreAuthorize("hasRole('USER')")
    @Cacheable(value = "CartRepository", key = "#cartId")
    ...
    @PreAuthorize("hasRole('USER')")
    @CacheEvict(value = "CartRepository", key = "'allCarts'")
    ...
    @PreAuthorize("hasRole('USER')")
    @CacheEvict(value = "CartRepository", allEntries = true)
